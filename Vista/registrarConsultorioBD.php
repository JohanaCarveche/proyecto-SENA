...
<?php
    ...
    print("El consultorio ingresado es:</br> $nombre</br>");


    if( $resultado = $conn->query("INSERT INTO consultorios(conNombre) VALUES ('".$nombre."')")=== TRUE ) {
      echo '<script>alert("consultorio registrado con éxito")</script>';
          } else {
          echo "Hubo un error ..." ;
          };
