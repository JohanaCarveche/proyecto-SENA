    ...
    <div class="row">
      <div class="col-sm-4"  style="background-color:#808080">
       ...
       <?php
        ...
        $estado=$_REQUEST['usuEstado'];
        $rol=$_REQUEST['usuRol'];

        $resultado = $conn->query("UPDATE  usuarios SET usuLogin = '$login', usuPassword = '$password', usuEstado ='$estado' , usuRol = '$rol'  WHERE usuarios.idUsuario = '".$id."'");
        $registro=$resultado;

        echo '<script>alert("Se actualizó el usuario con éxito")</script>';
        echo "<br/>**************<br/>Los datos actualizados son:</br>"."Login:    ". $login."<br/>"."Password: ". $password."<br/>"."Estado:   ". $estado."<br/>"."Rol:      ". $rol."<br/>**************<br/>";
