...
<div class="row">
    ...
    <div class="row">
      <div class="col-sm-4"  style="background-color:#808080">
        <h1>Actualizar Usuario</h1> 
     	...
     	<div class="col-sm-4 text-Justify"  style="background-color:#D3D3D3">
      	<h3>ingrese el Id del usuario que quiere Actualizar</h3>
        <form role="form" action="actualizarUsuarioBD.php" method=post>
      ...
      <div class="form-group">
        ...
        <div class="radio">
          <label><input type="radio" name="usuEstado" id="opciones_1" value="Activo" checked>Activo</label>
        </div>
        <div class="radio">
          <label><input type="radio" name="usuEstado" id="opciones_2" value="Inactivo">Inactivo</label>
        </div>
      </div>

      <div class="mb-2 form-group">
        <label for="usuRol">Rol:</label>
        <select name="usuRol" id="usuRol">
        <option value="Gerente">Gerente</option>
        <option value="Administrador">Administrador</option>
        <option value="Recepcionista">Recepcionista</option>
        <option value="Medico">Médico</option>
        <option value="Paciente">Paciente</option></select>
        <!--input type="text" class="form-control" id="usuRol"-->
      </div>
