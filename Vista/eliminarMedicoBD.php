    ...
    <div class="row">
      <div class="col-sm-4"  style="background-color:#808080">
		...
		<?php
			...
			print("<br/>**************<br/>El documento borrado es: $id</br>**************<br/>");
			

			if( $resultado = $conn->query("DELETE FROM medicos WHERE medicos.medIdentificacion = '".$id."' ") === TRUE ) {
			echo '<script>alert("Se borró el médico con éxito")</script>';
					} else {
					echo "Hubo un error ..." ;
					};
			$conn->close();
