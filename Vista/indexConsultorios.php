...
<head>
	...
	<title>Módulo consultorios</title>
...
<div class="row">
    ...
    <div class="row">
      <div class="col-sm-4"  style="background-color:#808080">
        <h1>Módulo consultorios</h1> 
      </div>
      <div class="col-sm-4 text-Justify"  style="background-color:#D3D3D3">
      	<blockquote class="blockquote">
        <p >
          <li><a href="registrarConsultorio.php">Registrar consultorio</a></li>
          <li><a href="actualizarConsultorio.php">Actualizar consultorio</a></li>
          <li><a href="consultarConsultorio.php">Consultar consultorio</a></li>
          <li><a href="eliminarConsultorio.php">Eliminar consultorio</a></li>
          </p>
