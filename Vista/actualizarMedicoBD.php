    ...
    <div class="row">
      <div class="col-sm-4"  style="background-color:#808080">
       ...
       <?php
        ...
        $resultado = $conn->query("UPDATE  medicos SET medNombres = '$nombres', medApellidos = '$apellidos', medEspecialidad ='$especialidad' , medTelefono = '$telefono', medCorreo='$correo'  WHERE medicos.medIdentificacion = '".$documento."'");
        $registro=$resultado;

        echo '<script>alert("Se actualizó el médico con éxito")</script>';
        echo "<br/>**************<br/>Los datos actualizados son:</br>"."Nombres:       ". $nombres."<br/>"."Apellidos:     ". $apellidos."<br/>"."Especialidad:  ". $especialidad."<br/>"."Teléfono:      ". $telefono."</br>"."Correo:        ".$correo."<br/>**************<br/>";
