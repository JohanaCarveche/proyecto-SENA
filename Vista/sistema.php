...
<div class="row">
    ...
    <div class="row">
      <div class="col-sm-4"  style="background-color:#808080">
        <h1>Módulos del Sistema de Información</h1> 
      </div>
      <div class="col-sm-4 text-Justify"  style="background-color:#D3D3D3">
      	<blockquote class="blockquote">
        <p>
          <li><a href="indexUsuarios.php">Módulo Usuarios</a></li>
          <li><a href="indexMedicos.php">Modulo Médicos</a></li>
          <li><a href="indexPacientes.php">Módulo Pacientes</a></li>
          <li><a href="indexConsultorios.php">Módulo Consultorios</a></li>
          <li><a href="indexCitas.php">Módulo Citas</a></li>
          </p>
