...
<div class="row">
    ...
    <div class="row">
      <div class="col-sm-4"  style="background-color:#808080">
        <h1>Módulo pacientes</h1> 
      </div>
      <div class="col-sm-4 text-Justify"  style="background-color:#D3D3D3">
      	<blockquote class="blockquote">
        <p >
          <li><a href="registrarPaciente.php">Registrar paciente</a></li>
          <li><a href="actualizarPaciente.php">Actualizar paciente</a></li>
