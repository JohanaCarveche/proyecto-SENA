...
if($resultado = $conn->query("SELECT idConsultorio,conNombre FROM consultorios WHERE consultorios.idConsultorio = '".$id."'")){
 while($registro = $resultado->fetch_assoc() ){

 echo "<br/>**************<br/>"."Id consultorio:     ". $registro["idConsultorio"]."<br/>"."Nombre:     ". $registro["conNombre"]."<br/>**************<br/>";
  };
