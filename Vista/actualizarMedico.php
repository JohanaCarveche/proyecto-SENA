      ...
      <div class="col-sm-4"  style="background-color:#808080">
        <h1>Actualizar Médico</h1> 
     	...
     	<div class="col-sm-4 text-Justify"  style="background-color:#D3D3D3">
      	<h3>ingrese el documento del médico que quiere Actualizar</h3>
        <form role="form" action="actualizarMedicoBD.php" method=post>

        <div class="form-group">
				<label for="medIdentificacion" class="col-sm-2 control-label">Documento:</label>
				<div class="col-sm-10">
