    ...
    <div class="row">
      <div class="col-sm-4"  style="background-color:#808080">
       ...
       $documento=$_POST['pacIdentificacion'];
        ...
        $resultado = $conn->query("UPDATE  pacientes SET pacNombres = '$nombres', pacApellidos = '$apellidos', pacFechaNacimiento ='$fechanacimiento' , pacSexo = '$sexo'  WHERE pacientes.pacIdentificacion = '".$documento."'");
        $registro=$resultado;

        echo '<script>alert("Se actualizó el paciente con éxito")</script>';
        echo "<br/>**************<br/>Los datos actualizados son:</br>"."Nombres:       ". $nombres."<br/>"."Apellidos:     ". $apellidos."<br/>"."Fecha de nacimiento:  ". $fechanacimiento."<br/>"."Sexo:      ". $sexo."<br/>**************<br/>";
