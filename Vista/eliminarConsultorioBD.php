    ...
    <div class="row">
      <div class="col-sm-4"  style="background-color:#808080">
		...
		<?php
			...
			print("<br/>**************<br/>El Id del consultorio borrado es: $id</br>**************<br/>");
			

			if( $resultado = $conn->query("DELETE FROM consultorios WHERE consultorios.idConsultorio = '".$id."' ") === TRUE ) {
			echo '<script>alert("Se borró el consultorio con éxito")</script>';
					} else {
					echo "Hubo un error ..." ;
					};
			$conn->close();
