...
<div class="row">
    ...
    <div class="row">
      ...
      <div class="col-sm-4 text-Justify"  style="background-color:#D3D3D3">
        ...
        <p >
          <li><a href="registrarMedico.php">Registrar médico</a></li>
          <li><a href="actualizarMedico.php">Actualizar médico</a></li>
          <li><a href="consultarMedico.php">Consultar médico</a></li>
          <li><a href="eliminarMedico.php">Eliminar médico</a></li>
          </p>
