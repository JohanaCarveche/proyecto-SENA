...
<div class="row">
      ...
      <div class="col-sm-4"  style="background-color:#808080">
        <h1>Actualizar Consultorio</h1> 
     	...
     	<div class="col-sm-4 text-Justify"  style="background-color:#D3D3D3">
      	<h3>ingrese el Id del consultorio que quiere Actualizar</h3>
        <form role="form" action="actualizarConsultorioBD.php" method=post>

        <div class="form-group">
				<label for="idConsultorio" class="col-sm-2 control-label">Id consultorio:</label>
				<div class="col-sm-10">
				<input type="text" class="form-control" name="idConsultorio" id="idConsultorio">
			</div>
			</div>
      <h3>Actualización de datos</h3>
      <div class="form-group">
        <label for="conNombre" class="col-sm-2 control-label">Nombre:</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" name="conNombre" id="conNombre">
          </div>
      </div>
      <div class="form-group">
    ...
    <div class="row justify-content-center">
       ...
       <div  class="col-sm-4" style="background-color:#98FB98">
        <h3 align="center">Volver al módulo consultorios</h3>
        <div class="col text-center">
        	
        <button class="mb-2 btn btn-success btn-sm"><a class="btn btn-sucess" href="indexConsultorios.php">volver</a></button>
    </div>
		</div>
    <div  class="col-sm-4" style="background-color:#98FB98">
