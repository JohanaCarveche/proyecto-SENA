...
$id=$_REQUEST['pacIdentificacion'];

if($resultado = $conn->query("SELECT idPaciente,pacNombres,pacApellidos,pacFechaNacimiento,pacSexo FROM pacientes WHERE pacientes.pacIdentificacion = '".$id."'")){
 while($registro = $resultado->fetch_assoc() ){


 echo "<br/>**************<br/>"."Id paciente:     ". $registro["idPaciente"]."<br/>"."Nombres:     ". $registro["pacNombres"]."<br/>"."Apellidos:     ". $registro["pacApellidos"]."<br/>"."Fecha de nacimiento:     ". $registro["pacFechaNacimiento"]."<br/>"."Sexo:     ". $registro["pacSexo"]."<br/>**************<br/>";
 };
