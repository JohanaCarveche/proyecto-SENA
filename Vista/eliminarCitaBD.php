    ...
    <div class="row">
      <div class="col-sm-4"  style="background-color:#808080">
		...
		<?php
			...
			print("<br/>**************<br/>El Id de la cita borrada es: $id</br>**************<br/>");
			

			if( $resultado = $conn->query("DELETE FROM citas WHERE citas.idCita = '".$id."' ") === TRUE ) {
			echo '<script>alert("Se borró la cita con éxito")</script>';
					} else {
					echo "Hubo un error ..." ;
					};
			$conn->close();
