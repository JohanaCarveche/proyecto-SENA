      ...
      <div class="col-sm-4"  style="background-color:#808080">
        <h1>Consultar Cita</h1> 
     	...
     	<div class="col-sm-4 text-Justify"  style="background-color:#D3D3D3">
      	<h3>ingrese el Id de la cita que quiere consultar</h3>
        <form role="form" action="consultarCitaBD.php" method=post>

        <div class="form-group">
				<label for="idCita" class="col-sm-2 control-label">Id Cita:</label>
				<div class="col-sm-10">
				<input type="text" class="form-control" name="idCita" id="idCita">
			</div>
			</div>
