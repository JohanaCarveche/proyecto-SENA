    ...
    <div class="row">
      <div class="col-sm-4"  style="background-color:#808080">
       ...
       <?php
        ...
        $resultado = $conn->query("UPDATE  consultorios SET conNombre = '$nombre' WHERE consultorios.idConsultorio = '".$id."'");
        $registro=$resultado;

        echo '<script>alert("Se actualizó el consultorio con éxito")</script>';
        echo "<br/>**************<br/>Los datos actualizados son:</br>"."Id consultorio:       ". $id."<br/>"."Nombre:     ". $nombre."<br/>**************<br/>";
